...
import { computed, defineAsyncComponent, ref, type ComponentPublicInstance } from 'vue'
...
// 复制路径/复制内容按钮：hover 弹性
useButtonFx(() => (rootRef.value?.$el as HTMLElement | null) ?? null, '.action-btn', {
